	...
	while (true) {
		...
		if (code == "1") {
			...
			for (int v = 0; v < vEntrada.size(); v++)
			{
				...
				string arquivoSemCompressao = "Huffman_SemCompressao_Iteracao_" + to_string(v+1) + ".txt";
				...
				string arquivoCompresso = "Huffman_Compresso_Iteracao_" + to_string(v+1) + ".txt";
				...
				cout << endl;
				saidaHuff += "\n================================================================================\n";
				salvarTxt(saidaHuff, "saidas.txt");
				comprime.clear();
				saida_Huf.clear();
				delete huf;
			}
